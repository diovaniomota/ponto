...
class LightModeColors {
  ...
  static const lightAppBarBackground = Color(0xFF1B5E20);
...
ThemeData get lightTheme => ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    border: OutlineInputBorder(
      ...
      borderSide: BorderSide(color: LightModeColors.lightPrimary.withValues(alpha: 0.3)),
    ),
...
ThemeData get darkTheme => ThemeData(
  ...
  inputDecorationTheme: InputDecorationTheme(
    border: OutlineInputBorder(
      borderRadius: BorderRadius.circular(12),
      borderSide: BorderSide(color: DarkModeColors.darkPrimary.withValues(alpha: 0.3)),
    ),
    enabledBorder: OutlineInputBorder(
      borderRadius: BorderRadius.circular(12),
      borderSide: BorderSide(color: DarkModeColors.darkPrimary.withValues(alpha: 0.3)),
